...
export default function Footer() {
  ...
  return (
    <footer className="body-font bg-gray-200">
            ...
            <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end">
              <div className="relative w-40 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4 mr-2">
                <input
                  ...
                  id="footer-field"
                  name="footer-field"
                  className="w-full bg-slate-50  rounded border border-gray-300 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 text-base outline-none py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                />
              </div>
      ...
      <div className="bg-gray-200">
        <div className="container py-2 mx-auto flex sm:flex-row flex-col">
          ...
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
            ...
            <a className="ml-3 hover:text-red-500">
              <svg
                fill="currentColor"
                strokeLinecap="round"
                strokeLinejoin="round"
